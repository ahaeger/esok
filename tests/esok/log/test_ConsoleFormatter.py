...
def test_notset_format():
    ...
    record = logging.makeLogRecord({u'msg': record_message,
                                    u'levelno': logging.NOTSET,
                                    u'levelname': u'NOTSET'})
